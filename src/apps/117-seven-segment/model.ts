  ...
  public constructor(nargs: {
    ...
    this._segments = [
      new SegmentModel({
        ...
        origin: new Point({x: weight / 2, y: 0}),
      ...
      new SegmentModel({
        ...
        origin: new Point({x: size.width - weight, y: weight / 2}),
      ...
      new SegmentModel({
        orientation: Orientation.vertical,
        origin: new Point({x: size.width - weight, y: size.height / 2}),
        length: (size.height - weight) / 2,
        weight: weight,
        color: color,
      }),
      new SegmentModel({
        orientation: Orientation.horizontal,
        origin: new Point({x: weight / 2, y: size.height - weight}),
        length: size.width - weight,
        weight: weight,
        color: color,
      }),
      new SegmentModel({
        orientation: Orientation.vertical,
        origin: new Point({x: 0, y: size.height / 2}),
        length: (size.height - weight) / 2,
        weight: weight,
        color: color,
      }),
      new SegmentModel({
        orientation: Orientation.vertical,
        origin: new Point({x: 0, y: weight / 2}),
        length: (size.height - weight) / 2,
        weight: weight,
        color: color,
      }),
      new SegmentModel({
        orientation: Orientation.horizontal,
        origin: new Point({x: weight / 2, y: (size.height - weight) / 2}),
        length: size.width - weight,
        weight: weight,
        color: color,
      }),
